...
function showLoading(wait){
   // $('.modal').modal('hide');
    ...
    $('.job_right').append('<div class="message-loading-overlay"><i style="top: 50%" class="fa fa-spin fa-spinner orange2 bigger-200"></i><div class="overlay-tip">'+wait+'</div></div>');
}
...
function removeLoading(){
    $('.job_right').find('.message-loading-overlay').remove();
}
